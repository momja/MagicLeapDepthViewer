...
namespace IVLab.Utilities.RemoteRendering
{
    ...
    public class RemoteRenderingClientView
    {
        ...
        {
            var UTS = UnityThreadScheduler.Instance;
            this.client = client;
            ConnectToServer();
                        ...
                        if (decompressedImageData != null)
                            await UnityThreadScheduler.Instance.RunMainThreadWork(() =>
                            {
                                ...
                                if (depthMeshObject == null)
                                {
                                    ...
                                    int l = LayerMask.NameToLayer("RemoteRendering");
                                    depthMeshObject.layer = l;
                                    ...
                                    depthMeshObject.AddComponent<MeshCollider>();
                                }
                                ...
                                depthMeshObject.GetComponent<MeshCollider>().sharedMesh = mesh;
